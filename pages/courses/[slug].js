        ...
        <div className="max-w-5xl mx-auto">
          { courseState === "purchased" &&
            <Message type="warning">
              ...
              <i className="block font-normal">In case of any questions, please contact info@SainaaDotNet.com</i>
            </Message>
          }
          { courseState === "activated" &&
            <Message type="success">
              SainaaDotNet wishes you happy watching of the course.
            </Message>
          }
          { courseState === "deactivated" &&
            <Message type="danger">
              ...
              <i className="block font-normal">Please contact info@SainaaDotNet.com</i>
            </Message>
          }
        </div>
      }
